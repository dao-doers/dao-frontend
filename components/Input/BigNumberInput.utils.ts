...
import { convertIntegerDecimalToDecimal, truncateDecimals } from 'utils/stringOperations';

// Change decimals to required, displayDecimals to optional
export const getDisplayValue = (value: BigNumber, displayDecimals: number, _decimals?: number): IDisplayValue => {
